...
{
    public class BinanceInstrumentViewModel : INotifyPropertyChanged
    {

        private BinanceInstrument _dataModel;
        public BinanceInstrument DataModel
        {
        ...
        public BinanceInstrumentViewModel(BinanceInstrument dataModel)
        {
            DataModel = dataModel;
