...
{
    public class Binance : ConnectionBase, IDataProvider
    {
        ...
        public override IDataProviderClient Client
        {
            get
            {
                if (_client == null)
                {
                    ...
                    if (_options == null && Options is BinanceConnectionOptions binanceConnectionOptions)
                        _options = binanceConnectionOptions;
        ...
        private BinanceConnectionOptions _options;

        public Binance()
        {
            InstrumentType = typeof(BinanceInstrument);
        }
        ...
        public override List<DataSeriesValue> GetDataFormats()
        {
            return new List<DataSeriesValue>()
            {
                ...
                new DataSeriesValue() {Value = 8, Type = DataSeriesType.Hour, Name = "8h" },
                ...
                new DataSeriesValue() {Value = 3, Type = DataSeriesType.Day, Name = "3d" },
        ...
        {
            if (Options is BinanceConnectionOptions options)
            {
                _options = options;
            ...
            try
            {
                ...
                if (await Task.Run(() => Client.Connect(null)))
                {
                    ...
                    IsConnected = true;                    
                    LogController.Print("Binance successfully connected!");
                ...
                else
                {
                    ...
                    LogController.Print($"Binance not connected: {Client.Message}");
            ...
            catch (Exception ex)
            {
                ...
                OnPropertyChanged("IsConnected");
                LogController.Print($"Binance not connected: {ex.Message}");
            }
        ...
        public async Task<IEnumerable<object>> GetInstruments()
        {
            ...
            return Enumerable.Empty<BinanceInstrument>();
        ...
        {
            return new BinanceInstrumentManager(this);
        }
    }
}