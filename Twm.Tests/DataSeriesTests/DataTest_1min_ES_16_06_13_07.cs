...
{
    public class DataTest_1min_ES_16_06_13_07
    {
        ...
        [Test]
        [Order(1)]
        [Category("DataTest_1min_ES_16_06_13_07")]
        public void T02_CandlesClosePriceCheck()
        {

            var fileDataPath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "Data", "ClosePrices_1606_1307.txt");
        ...
        {
            var fileDataPath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "Data", "OpenPrices_1606_1307.txt");
            string[] arr = File.ReadAllLines(fileDataPath);
            var ntValues = Array.ConvertAll(arr, i => Convert.ToDouble(i, CultureInfo.InvariantCulture)).ToList();
        ...
        {
            var fileDataPath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "Data", "HighPrices_1606_1307.txt");
            string[] arr = File.ReadAllLines(fileDataPath);
            var ntValues = Array.ConvertAll(arr, i => Convert.ToDouble(i, CultureInfo.InvariantCulture)).ToList();
        ...
        {
            var fileDataPath = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "Data", "LowPrices_1606_1307.txt");
            string[] arr = File.ReadAllLines(fileDataPath);
            var ntValues = Array.ConvertAll(arr, i => Convert.ToDouble(i, CultureInfo.InvariantCulture)).ToList();
