...
namespace Twm.Chart.Classes
{
    ...
    class MyDateAndTime
    {
        ...
        public static bool IsInSameMinute(DateTime t1, DateTime t2)
        {
        ...
        public static bool IsSecondMultipleOf(DateTime t, int timeStep)
        {
            int s = 60 * (t.Hour - 10) + t.Minute * 60 + t.Second;
            return s % timeStep == 0 ? true : false;
        }
